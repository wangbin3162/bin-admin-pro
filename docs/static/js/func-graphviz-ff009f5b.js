import{l as d,B as C,e as N,w as l,E as n,o as $,c as e,b as _,m as c,ay as M}from"./vendor-f584ffdc.js";import{a as O}from"./chunk-bin-ui-next-9b299e9d.js";import"./chunk-brace-3ad28406.js";const T={class:"p10"},U={class:"p10"},D=_("br",null,null,-1),E={class:"p10"},J={class:"pt-8"},q={class:"pt-8"},W={__name:"func-graphviz",setup(F){const V=d("digraph G {Hello -> World}"),v=d("digraph G {a -> b}"),h=d(v.value),j=`digraph G {
