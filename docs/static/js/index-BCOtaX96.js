import{a8 as X,r as B,l as ce,Q as n,o as g,j as E,w as a,K as e,f as h,a as O,b as s,F as H,R as te,L as i,t as ae,i as L,a9 as le,aa as oe,X as ie,Z as ne,aE as ue,c as de,ag as pe,g as re,v as me,ac as G,ah as _e,n as fe}from"./vendor-BdSUmcRD.js";import{n as q}from"./chunk-bin-ui-design-XqwoFEXm.js";import{i as W,j as ve,k as ge}from"./index-DToxBuuX.js";import{I as Y}from"./env-CxIDJ12h.js";import{a as be,s as ee,m as he,g as ye}from"./cross-tab-msg-C5kJqK5u.js";import{c as Ve,M as K,m as c,O as Q,a as ke,u as Ce,d as we,e as v,f as Se,i as xe}from"./useData-uhZC7-o-.js";import"./chunk-brace-DkiLfVT0.js";import"./chunk-mockjs-B6s4ORgB.js";const S=w=>(le("data-v-cf196e43"),w=w(),oe(),w),Ie={key:0,class:"source-config"},De=S(()=>s("span",{class:"tooltip-label",title:"请输入选项，以英文逗号分割，如1,2,3,4"},"数据值",-1)),$e=S(()=>s("span",{class:"tooltip-label",title:"填写依赖的单元格索引，如B1"},"依赖项",-1)),Te=S(()=>s("span",{class:"tooltip-label",title:"编写Json格式的数据值，key值为依赖索引的值，如A对应1,2编写为 { 'A': '1,2' }"}," 数据值 ",-1)),Me=S(()=>s("div",null,"使用MATCH(D11, A1:A7, 0)函数获取数据项内容",-1)),Oe=S(()=>s("div",null,"第一个参数为填充到哪个单元格",-1)),Re=S(()=>s("div",null,"第二个参数为单元格选区",-1)),Ue=S(()=>s("div",null,"第三个参数为哪个工作表索引",-1)),Ae=S(()=>s("div",null,"COUNTIF(A1:A7,B1:B7)函数设置条件过滤",-1)),Be=S(()=>s("div",null,"第一个参数为条件key值取值内容",-1)),Ne=S(()=>s("div",null,"第二个参数为实际选项内容",-1)),Ee=S(()=>s("div",null,"注意：COUNTIF 函数需要配合MATCH函数共同使用",-1)),Le=S(()=>s("span",{class:"tooltip-label",title:"使用MATCH()函数获取数据项内容"},"数据值",-1)),ze={key:1,style:{height:"328px"}},Fe={__name:"SourceModal",emits:["save"],setup(w,{expose:r,emit:R}){const x=R,f=B(!1),o=B({}),U=B(!1);function z(I){U.value=!1,f.value=!0,o.value=W(I)}const j=ce(()=>Ve(o.value.dependOn));function P(){if(o.value.type==="cascade"&&!F())return;const I=W(o.value);f.value=!1,x("save",I)}function F(){try{const I=JSON.parse(o.value.cascade);return o.value.cascade=JSON.stringify(I,null,2),!0}catch{return q.error("请输入正确的对象映射！"),!1}}return r({open:z}),(I,u)=>{const J=n("b-radio"),l=n("b-radio-group"),t=n("b-form-item"),d=n("b-input"),m=n("b-col"),y=n("b-row"),k=n("b-ace-editor"),V=n("b-button"),D=n("b-tag"),M=n("b-tooltip"),A=n("b-space"),C=n("b-form"),N=n("b-loading"),$=n("b-modal");return g(),E($,{title:"数据源配置",modelValue:f.value,"onUpdate:modelValue":u[6]||(u[6]=p=>f.value=p),width:"1200px",draggable:"",top:"80px","esc-closable":"","append-to-body":"",onOpened:u[7]||(u[7]=p=>U.value=!0)},{footer:a(()=>[e(V,{onClick:u[5]||(u[5]=p=>f.value=!1)},{default:a(()=>[h("关闭")]),_:1}),e(V,{type:"primary",onClick:P},{default:a(()=>[h("保存")]),_:1})]),default:a(()=>[U.value?(g(),O("div",Ie,[e(C,{"label-width":"120px"},{default:a(()=>[e(t,{label:"数据源类型"},{default:a(()=>[s("div",null,[e(l,{modelValue:o.value.type,"onUpdate:modelValue":u[0]||(u[0]=p=>o.value.type=p),type:"capsule"},{default:a(()=>[(g(!0),O(H,null,te(i(K).DatasourceType.mapping,(p,T)=>(g(),E(J,{key:T,label:T},{default:a(()=>[h(ae(p),1)]),_:2},1032,["label"]))),128))]),_:1},8,["modelValue"])])]),_:1}),o.value.type==="normal"?(g(),E(t,{key:0,label:"数据值"},{label:a(()=>[De]),default:a(()=>[s("div",null,[e(d,{modelValue:o.value.normal,"onUpdate:modelValue":u[1]||(u[1]=p=>o.value.normal=p),placeholder:"请输入选项，以英文逗号分割，如1,2,3,4",clearable:""},null,8,["modelValue"])])]),_:1})):L("",!0),o.value.type==="cascade"?(g(),O(H,{key:1},[e(t,{label:"依赖项"},{label:a(()=>[$e]),default:a(()=>[e(y,{gutter:4},{default:a(()=>[e(m,{span:"18"},{default:a(()=>[e(d,{modelValue:o.value.dependOn,"onUpdate:modelValue":u[2]||(u[2]=p=>o.value.dependOn=p),placeholder:"依赖的单元格索引，如B1"},null,8,["modelValue"])]),_:1}),e(m,{span:"6"},{default:a(()=>[e(d,{"model-value":JSON.stringify(j.value),readonly:""},null,8,["model-value"])]),_:1})]),_:1})]),_:1}),e(t,{label:"数据值"},{label:a(()=>[Te]),default:a(()=>[s("div",null,[e(k,{height:"200",modelValue:o.value.cascade,"onUpdate:modelValue":u[3]||(u[3]=p=>o.value.cascade=p)},null,8,["modelValue"]),e(V,{type:"text",onClick:F},{default:a(()=>[h("格式化")]),_:1})])]),_:1})],64)):L("",!0),o.value.type==="fx"?(g(),O(H,{key:2},[e(t,{label:"支持函数"},{default:a(()=>[e(A,null,{default:a(()=>[e(M,{placement:"top",theme:"light"},{content:a(()=>[Me,Oe,Re,Ue]),default:a(()=>[e(D,null,{default:a(()=>[h("MATCH")]),_:1})]),_:1}),e(M,{placement:"top",theme:"light"},{content:a(()=>[Ae,Be,Ne,Ee]),default:a(()=>[e(D,null,{default:a(()=>[h("COUNTIF")]),_:1})]),_:1})]),_:1})]),_:1}),e(t,{label:"数据值"},{label:a(()=>[Le]),default:a(()=>[s("div",null,[e(d,{modelValue:o.value.fx,"onUpdate:modelValue":u[4]||(u[4]=p=>o.value.fx=p),type:"textarea"},null,8,["modelValue"])])]),_:1})],64)):L("",!0)]),_:1})])):(g(),O("div",ze,[e(N)]))]),_:1},8,["modelValue"])}}},je=X(Fe,[["__scopeId","data-v-cf196e43"]]),Pe={class:"mapping-config"},Je=de('<div class="top-title" data-v-021bee72><span class="l1" data-v-021bee72>位置</span><span class="l2" data-v-021bee72>字段标识</span><span class="l3" data-v-021bee72>字段名称</span><span class="l4" data-v-021bee72>类型</span><span class="l5" data-v-021bee72>数据源</span><span class="l6" data-v-021bee72>事件</span></div>',1),He={class:"mapping-item"},qe={class:"mapping-content"},Ke={flex:"main:center cross:center",style:{width:"44px"}},Qe={flex:"main:center cross:center",style:{width:"60px"}},Xe={__name:"MappingConfig",setup(w){const r=window.luckysheet;function R(l){c.value.splice(l,1)}const x=[`/**
